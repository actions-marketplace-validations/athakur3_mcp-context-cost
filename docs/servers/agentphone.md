...
**6,139 tokens** across 28 tools — *moderate* (5–15K). Measured 2026-09-16 under [methodology v1.0](../METHODOLOGY.html).

An Anthropic request carries 5,587 of those tokens as tool definitions. What Claude makes of them is not published for this server: its Claude count is missing, or was taken against a capture this measurement has since replaced.
...
| canonical SHA-256 | `d8e7072a1f0c7a586c9a7f4550329242fdaec8228d6f3acba0ea09cc106f12fa` |
| category | community |
...
| 2026-09-16 | 6,139 | 28 | 0.7.0 | docker | +5 |
